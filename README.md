...
## How to use  
```bash
run_on_win_guest msbuild to_compile_by_service_test.sln /t:Rebuild /p:Configuration=Debug;Platform=x64  
run_on_win_guest devenv to_compile_by_service_test.sln /rebuild "Debug|x64"  
